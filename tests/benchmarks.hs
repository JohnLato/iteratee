...
main = defaultMain allListBenches
...
list2 = BDIterN "stream2list chunk by 4" 4 sum stream2list
list3 = BDIterN "stream2list chunk by 1024" 1024 sum stream2list
slistBenches = [list1, list2, list3]

stream1 = BDIter1 "stream2stream one go" sum stream2stream
stream2 = BDIterN "stream2stream chunk by 4" 4 sum stream2stream
stream3 = BDIterN "stream2stream chunk by 1024" 1024 sum stream2stream
...
breakBenches = [break0, break0', break1, break2, break3, break4, break5]
...
takeBenches = [take0, take1, take2, take3, take4, take5, take6]
...
takeRBenches = [takeR0, takeR1, takeR2, takeR3, takeR4, takeR5, takeR6]
